...
<div class="card-box mb-30">
    <div class="pd-20">
        <div class="d-flex justify-content-between align-items-start flex-wrap">
            <div>
                <h4 class="mb-1">Data Pesanan Menunggu</h4>
                <small class="text-muted">Kelola semua pesanan yang sedang menunggu diproses</small>
            </div>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?= base_url('admin/data_pesanan/update_status') ?>" method="POST" style="margin: 0;" id="form-status-<?= $row->id_pesanan ?>">
                                    ...
                                    <div class="dropdown">
                                        <button class="btn badge badge-warning dropdown-toggle border-0" type="button" data-toggle="dropdown" aria-expanded="false" style="color: #fff; padding: 6px 12px; font-size: 12px; font-weight: 500; cursor: pointer; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
                                            Menunggu
                                        </button>

...
<div class="card-box mb-30">
    <div class="pd-20">
        <div class="d-flex justify-content-between align-items-start flex-wrap">
            <div>
                <h4 class="mb-1">Data Pesanan</h4>
                <small class="text-muted">
                    Kelola semua pesanan
                </small>
            </div>

            <a href="<?= base_url('admin/data_pesanan/tambah') ?>" class="btn btn-primary">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                        <a class="dropdown-item"
                                            href="<?= base_url('admin/data_pesanan/detail?id_pesanan=' . $row->id_pesanan) ?>">
                                            <i class="dw dw-eye"></i> View
                                        </a>
                                        <a class="dropdown-item"
                                            href="<?= base_url('admin/data_pesanan/edit?id_pesanan=' . $row->id_pesanan) ?>">
                                            <i class="dw dw-edit2"></i> Edit
                                        </a>
                                        <a class="dropdown-item tombol-hapus"
                                            href="<?= base_url('admin/data_pesanan/hapus?id_pesanan=' . $row->id_pesanan) ?>">
